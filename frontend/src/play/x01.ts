 ...
 *
 * What is *not* here is anything true of a leg whatever game it is -- which leg
 * takes the next dart, whether it accepts one, how a refusal reads. #24 wrote
 * those here because x01 was the only board there was; #25 needs the same
 * answers, so they moved to `play/leg.ts` and both boards import them.
 */
